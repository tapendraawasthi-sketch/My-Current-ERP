...
var periodLock_1 = require("../src/lib/periodLock");
var periodLockService_1 = require("../src/lib/ledger/periodLockService");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    db = (0, db_1.getDB)();
                    return [4 /*yield*/, (0, periodLock_1.importLegacyPeriodLocksIntoDexie)(db, { clearLocalStorageAfterImport: true })];
                case 1:
                    result = _a.sent();
                    (0, periodLockService_1.invalidatePeriodLockCache)();
