...
export default function TrustModal({ open, onClose }: TrustModalProps) {
  if (!open) return null;
    ...
    <div className="fixed inset-0 z-50 flex items-end bg-black/40 p-4 sm:items-center">
      <div className="w-full max-w-md rounded-md bg-white p-4 shadow-lg">
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-4 h-8 w-full rounded-md border border-gray-300 text-[12px] font-medium text-gray-700"
        >
          Close
        </button>
      </div>
