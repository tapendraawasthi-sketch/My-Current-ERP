...
- [ ] NLU test suite passes (15/15 sentences)
- [ ] Ledger correctness tests pass (6/6 voucher types)
...
- [ ] No PAN/VAT fields in any Khata-facing UI (compliance-pipe check)
- [ ] `.env.example` has ESEWA_MERCHANT_ID, KHALTI_PUBLIC_KEY, PAYMENT_WEBHOOK_SECRET
