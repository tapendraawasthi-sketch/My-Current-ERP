...
**Runtime:** `mai-53.0.1-slice1` (engineering; not production-approved)
...
reminder automation, obligation tracking, due-date alert) without creating
obligations, sending reminders, arming automation, or submitting filings.
...
| Case | Expect |
|------|--------|
| Compliance obligation / deadline / calendar / reminder / tracking / alert cues | COMPLETE → `POLICY_DECLARED` |
