...
- **Progress (2026-07-19):** MAI-08 slice 1 `IN_PROGRESS` — candidate-only `TypoCodeMixBundleV1` + EntityEnricher abstention floors (party 0.75 / item 0.78 / gap 0.12). Does **not** close this gap.
