...
- **Phase:** MAI-40-FINANCIAL-CLOSE-ADJUSTMENT-ASSISTANCE (slice 1)
...
| Alternative | Why |
|-------------|-----|
| Post close/adjustments in slice 1 | Authority / honesty risk |
...
- `docs/mokxya-ai/baselines/MAI_40_SLICE1_BASELINE_SUMMARY.md`
