...
def khata_chat(
    ...
    # Fast NLU fallback before LLM structured parse
    if _is_transaction_signal(text):
        ...
        if nlu_parsed.get("clarifying_question"):
            reply = _invoke_llm(
                ...
                lang,
                context=context,
                extra_instruction=_clarify_instruction(str(nlu_parsed["clarifying_question"])),
            )
            return {
                "kind": "clarify",
                "reply": reply,
        ...
        if nlu_card and _journal_balanced(nlu_card):
            ...
            reply = _invoke_llm(
                ...
                lang,
                context=context,
                extra_instruction=_entry_instruction(nlu_card, lang),
            )
            return {
                "kind": "entry",
                "reply": reply,
