    ...
    def rank(
        ...
        *,
        ...
        for c in candidates:
            ...
            if c.is_identity:
                if language_form in {"ENGLISH", "TECHNICAL_ACCOUNTING_ENGLISH"} or lower in self.res.english_identity:
                    score += 0.35
            ...
            # Penalize Devanagari on hard English unless domain explicitly wants it and context boosts
            if (
                not c.is_identity
                and language_form in {"ENGLISH", "TECHNICAL_ACCOUNTING_ENGLISH"}
                and lower in self.res.english_identity
            ):
                score -= 0.5
