"""MAI-07R3N independent audit scorer.

Does not import canonical scoring helpers from eval_mai07_r3n_canonical_scorer.
"""
...
def score_observations_audit(
    ...
    *,
    ...
    specs = [
        ...
        ("romanized_script_at_5", "ROMANIZED_NEPALI_REQUIRED", lambda o: o["devanagari_at_5"], 0.90, ">="),
    ...
    return {
        "scorer_id": "mai07_r3n_audit_scorer",
