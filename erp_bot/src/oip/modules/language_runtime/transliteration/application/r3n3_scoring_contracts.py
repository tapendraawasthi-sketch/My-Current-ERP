"""MAI-07R3N3 versioned scoring contracts.
...
SCORER_VERSION = "mai-07-r3n3.scorer.1.0.0"
FORMULA_VERSION = "mai-07-r3n3.formula.1.0.0"
CONTRACT_VERSION = "mai-07-r3n3.contract.1.0.0"
...
MINIMUM_DENOMINATORS = {
    ...
    "IDENTITY_RETENTION_REQUIRED": 300,
    "IDENTITY_INVARIANT_ANALOGUE": 250,
    "CANDIDATE_CAP_PRESSURE": 250,
    ...
    "IDENTITY_CAP_PRESSURE_CHALLENGE": 400,
}

SPLIT_SIZE_MINIMA = {
    "DEVELOPMENT": 600,
    "HOLDOUT_VALIDATION": 1200,
...
def metric_required_when_empty(metric_id: str, split: str) -> bool:
    ...
    if metric_id == "cap_pressure_identity_retention" and split == "IDENTITY_CAP_PRESSURE_CHALLENGE":
        return True
...
def check_population_minima(population_counts: dict[str, int], *, split: str) -> dict:
    ...
    elif split == "IDENTITY_CAP_PRESSURE_CHALLENGE":
        have = int(population_counts.get("IDENTITY_CAP_PRESSURE_CHALLENGE", 0))
        if have < MINIMUM_DENOMINATORS["IDENTITY_CAP_PRESSURE_CHALLENGE"]:
            failures.append(
                {
                    "population_id": "IDENTITY_CAP_PRESSURE_CHALLENGE",
                    "have": have,
                    "minimum": MINIMUM_DENOMINATORS["IDENTITY_CAP_PRESSURE_CHALLENGE"],
                }
            )
    return {
        "ok": not failures,
