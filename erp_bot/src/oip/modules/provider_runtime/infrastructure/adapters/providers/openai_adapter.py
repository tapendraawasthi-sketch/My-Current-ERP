...
class OpenAIProviderAdapter(HttpProviderAdapter):
    ...
    async def _invoke_complete(
        ...
        *,
        ...
        try:
            ...
            raise ProviderNetworkError(f"openai network failure: {exc}") from exc
    ...
    async def _invoke_streaming(
        ...
        *,
        ...
        try:
            ...
            raise ProviderTimeoutError("openai stream timed out") from exc
        except httpx.HTTPError as exc:
            raise ProviderNetworkError(f"openai stream failure: {exc}") from exc
