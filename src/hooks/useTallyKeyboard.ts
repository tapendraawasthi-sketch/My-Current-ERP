 ...
 */
export const useTallyKeyboard = (actions: KeyboardActionMap, enabled = true): void => {
    ...
    (e: KeyboardEvent) => {
      ...
      if (ctrl && !alt && !shift) {
        switch (key.toLowerCase()) {
          case "a":
            fire(actions.onCtrlA);
            return;
          case "enter":
            fire(actions.onCtrlA);
            return; // Ctrl+Enter alias
          case "d":
            fire(actions.onCtrlD);
            return;
          case "h":
            fire(actions.onCtrlH);
            return;
          case "i":
            fire(actions.onCtrlI);
            return;
          case "t":
            fire(actions.onCtrlT);
            return; // ← new Post-Dated
          case "l":
            fire(actions.onCtrlL);
            return; // ← new Optional
          case "r":
            fire(actions.onCtrlR);
            return; // ← new Recall narration
          case "v":
            fire(actions.onCtrlV);
            return; // ← new Invoice/Voucher
          default:
            break;
        }
      }
      ...
      if (alt && !ctrl) {
        switch (key.toLowerCase()) {
          ...
          case "r":
            fire(actions.onAltR);
            return; // ← new Recall (party)
          case "i":
            fire(actions.onAltI);
            return; // ← new Item/Acctg toggle
          case "j":
            fire(actions.onAltJ);
            return; // ← new Stat adjust
          case "s":
            fire(actions.onAltS);
