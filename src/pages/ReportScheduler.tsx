...
export default function ReportScheduler() {
  ...
  const handleSaveSchedule = async () => {
    ...
    try {
      ...
      const scheduleData = {
        ...
        subjectLine: editingSchedule.subjectLine || `[${companySettings?.name || 'Company'}] ${editingSchedule.reportType} - ${editingSchedule.reportFilters.dateRange}`,
  ...
  const handleTestSend = () => {
    ...
    toast.success(`Test email would be sent to ${recipients.length} recipients. (Email sending requires backend SMTP configuration.)`);
  };
  ...
  return (
    <div style={{ backgroundColor: BG, minHeight: '100vh', padding: '20px', display: 'flex', gap: '20px' }}>
      ...
      <div style={{ width: '260px', backgroundColor: BG_CARD, border: BORDER, padding: '15px', borderRadius: '8px' }}>
        ...
        <div style={{ maxHeight: '600px', overflowY: 'auto' }}>
          {schedules.map(schedule => (
            ...
            >
              <div style={{ fontWeight: 'bold', fontSize: '12px', marginBottom: '3px' }}>{schedule.name}</div>
              <div style={{ fontSize: '11px', color: '#666', marginBottom: '3px' }}>
                <span style={{
                  backgroundColor: schedule.frequency === 'daily' ? '#059669' : 
                                  schedule.frequency === 'weekly' ? '#d97706' : '#dc2626',
                  color: 'white',
                  padding: '1px 4px',
                  borderRadius: '10px',
                  fontSize: '9px',
      ...
      <div style={{ flex: 1, backgroundColor: BG_CARD, border: BORDER, padding: '20px', borderRadius: '8px' }}>
        <div style={{ backgroundColor: BG_HEADER, padding: '10px', borderRadius: '4px', marginBottom: '20px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '15px' }}>
          <div>
            <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Schedule Name*</label>
            <input
              type="text"
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Report Type*</label>
            <select
        ...
        {(editingSchedule.reportType.includes("Outstanding") || 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '15px' }}>
            <div>
              <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Party Filter</label>
              <select
        ...
        {(editingSchedule.reportType.includes("Stock") || 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '15px' }}>
            <div>
              <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Limit to Top N Items</label>
              <select
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '15px' }}>
          <div>
            <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Date Range</label>
            <select
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Time to Run</label>
            <input
              type="time"
        ...
        <div style={{ marginBottom: '15px' }}>
          <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Frequency*</label>
          ...
          {editingSchedule.frequency === "weekly" && (
            <div style={{ marginTop: '10px' }}>
              <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Day of Week</label>
              <select
          ...
          {editingSchedule.frequency === "monthly" && (
            <div style={{ marginTop: '10px' }}>
              <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Day of Month</label>
              <select
        ...
        <div style={{ marginBottom: '15px' }}>
          <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Recipients* (One email per line)</label>
          <textarea
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '15px', marginBottom: '15px' }}>
          <div>
            <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>File Format</label>
        ...
        <div style={{ marginBottom: '15px' }}>
          <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Subject Line</label>
          <input
            type="text"
        ...
        <div style={{ marginBottom: '20px' }}>
          <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold', fontSize: '12px' }}>Email Body Note</label>
          <textarea
      ...
      <div style={{ width: '300px', backgroundColor: BG_CARD, border: BORDER, padding: '15px', borderRadius: '8px' }}>
        <div style={{ backgroundColor: BG_HEADER, padding: '10px', borderRadius: '4px', marginBottom: '15px' }}>
          <h2 style={{ fontSize: '14px', fontWeight: 'bold', color: '#000000', margin: 0, display: 'flex', alignItems: 'center', gap: '5px' }}>
            <Clock size={16} />
            Delivery History
        ...
        <div style={{ maxHeight: '600px', overflowY: 'auto' }}>
          {selectedSchedule ? (
            <div>
              ...
              <div style={{ marginBottom: '10px', padding: '8px', border: BORDER, borderRadius: '4px' }}>
                <div style={{ fontSize: '11px', color: '#666' }}>2023-06-15</div>
                <div style={{ fontSize: '10px', color: '#888' }}>Format: Excel</div>
                <div style={{ fontSize: '10px', color: '#059669', fontWeight: 'bold' }}>Downloaded</div>
              </div>
              <div style={{ marginBottom: '10px', padding: '8px', border: BORDER, borderRadius: '4px' }}>
              ...
              <div style={{ marginBottom: '10px', padding: '8px', border: BORDER, borderRadius: '4px' }}>
                ...
                <div style={{ fontSize: '10px', color: '#888' }}>Format: Excel</div>
                <div style={{ fontSize: '10px', color: '#d97706', fontWeight: 'bold' }}>Pending</div>
              </div>
            </div>
          ) : (
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', color: '#92400e' }}>
          <span>ℹ️ Note: Reports run locally and download to your device. For automatic scheduled email delivery, configure your SMTP server in System Settings and deploy the backend scheduler.</span>
        </div>
      </div>
    </div>
  );
