                ...
                filteredCheques.map(cheque => {
                  ...
                  return (
                    <tr key={cheque.id} className="border-t hover:bg-gray-50">
                      ...
                      <td className="p-3">
                        <Badge 
                          variant={cheque.isPrinted ? "success" : "warning"}
                        >
      ...
      {setupModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg w-full max-w-2xl max-h-[80vh] overflow-auto">
            ...
            <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <input
                  ...
                  onChange={(e) => setChequeBookForm(prev => ({ ...prev, bankName: e.target.value }))}
              ...
              <div>
                <input
                  ...
                  onChange={(e) => setChequeBookForm(prev => ({ ...prev, branchName: e.target.value }))}
                  className="w-full p-2 border rounded text-sm"
                />
              </div>
              ...
              <div>
                <input
                  ...
                  onChange={(e) => setChequeBookForm(prev => ({ ...prev, accountNumber: e.target.value }))}
                  className="w-full p-2 border rounded text-sm"
                />
              </div>
              ...
              <div>
                <input
                  ...
                  onChange={(e) => setChequeBookForm(prev => ({ ...prev, chequeBookNo: e.target.value }))}
                  className="w-full p-2 border rounded text-sm"
                />
              </div>
              ...
              <div>
                <input
                  ...
                  onChange={(e) => setChequeBookForm(prev => ({ ...prev, fromChequeNo: e.target.value }))}
                  className="w-full p-2 border rounded text-sm"
                />
              </div>
              ...
              <div>
                <input
                  ...
                  onChange={(e) => setChequeBookForm(prev => ({ ...prev, toChequeNo: e.target.value }))}
                  className="w-full p-2 border rounded text-sm"
                />
              </div>
              ...
              <div>
                <input
                  ...
                  onChange={(e) => setChequeBookForm(prev => ({ ...prev, currentChequeNo: e.target.value }))}
                  className="w-full p-2 border rounded text-sm"
                />
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setChequeBookForm(prev => ({ ...prev, payeeX: Number(e.target.value) }))}
                      className="w-full p-2 border rounded text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setChequeBookForm(prev => ({ ...prev, payeeY: Number(e.target.value) }))}
                      className="w-full p-2 border rounded text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setChequeBookForm(prev => ({ ...prev, amountWordsX: Number(e.target.value) }))}
                      className="w-full p-2 border rounded text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setChequeBookForm(prev => ({ ...prev, amountWordsY: Number(e.target.value) }))}
                      className="w-full p-2 border rounded text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setChequeBookForm(prev => ({ ...prev, amountFiguresX: Number(e.target.value) }))}
                      className="w-full p-2 border rounded text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setChequeBookForm(prev => ({ ...prev, amountFiguresY: Number(e.target.value) }))}
                      className="w-full p-2 border rounded text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setChequeBookForm(prev => ({ ...prev, dateX: Number(e.target.value) }))}
                      className="w-full p-2 border rounded text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setChequeBookForm(prev => ({ ...prev, dateY: Number(e.target.value) }))}
                      className="w-full p-2 border rounded text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setChequeBookForm(prev => ({ ...prev, pageWidth: Number(e.target.value) }))}
                      className="w-full p-2 border rounded text-sm"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setChequeBookForm(prev => ({ ...prev, pageHeight: Number(e.target.value) }))}
                      className="w-full p-2 border rounded text-sm"
                    />
                  </div>
                </div>
            ...
            <div className="p-4 border-t flex justify-end gap-2">
              <Button variant="outline" onClick={() => setSetupModalOpen(false)}>Cancel</Button>
