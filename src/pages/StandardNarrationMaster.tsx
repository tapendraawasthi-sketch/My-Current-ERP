      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        <div className="p-3 border-b border-gray-200 flex items-center gap-3 flex-wrap">
          <div className="relative">
            ...
            <input
              ...
              className="h-8 pl-8 pr-3 text-[12px] border border-gray-300 rounded-md w-56 focus:outline-none focus:ring-2 focus:ring-[#1557b0]/20"
            />
          </div>
          <select
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            {filtered.length === 0 && (
              <tr>
                <td colSpan={5} className="py-12 text-center text-[12px] text-gray-500">
                  No narrations found
                </td>
              </tr>
            )}
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
            <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
              <h2 className="text-[15px] font-semibold text-gray-800">
                {editItem ? "Modify Narration" : "Add Narration"}
              </h2>
              <button
