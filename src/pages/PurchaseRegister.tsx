...
const ALL_COLUMNS: ColumnDef[] = [
  ...
  { key: "party", label: "Supplier", defaultVisible: true, width: "22%" },
...
const PurchaseRegister: React.FC = () => {
  ...
  const handleExportIRD = () => {
    console.log("Export IRD Annex A format");
  };
      ...
      <div className="px-4 shrink-0">
        <div className="no-print bg-white border border-gray-200 rounded-md p-3 mb-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-3">
            ...
            <div>
              <label className="block text-[12px] font-medium text-gray-600 mb-1">Supplier</label>
              <input
                type="text"
        ...
        {filteredInvoices.length === 0 ? (
          ...
          <div className="bg-white border border-gray-200 rounded-md overflow-hidden flex flex-col flex-1 min-h-0">
            ...
            <div className="px-3 py-2 border-t border-gray-200 bg-[var(--ds-surface-muted)] text-[12px] text-gray-500 shrink-0">
              {filteredInvoices.length} purchase register record
