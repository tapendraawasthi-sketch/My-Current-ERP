  ...
  const salesInvoices = useMemo(() => {
    return invoices.filter(
      (inv) =>
        ...
        inv.type === VoucherType.SALES_RETURN
    );
  }, [invoices]);
  ...
  return (
    <div className="flex flex-col gap-4 animate-fadeIn pb-4 text-xs select-none">
      ...
      <div className="grid grid-cols-4 gap-3 mb-3">
        {[
          { label: "Total Sales", value: formatCurrency(filteredInvoices.reduce((s,r)=>s+(r.grandTotal||0),0)), color: "var(--color-positive)" },
        ...
        <table className="data-table">
          <thead>
            <tr className="bg-[#eef1f8] border-b-2 border-[#c5cad8]">
              ...
              <th className="px-3 py-2 text-[10px] font-bold text-[#4b5563] uppercase tracking-[0.06em] text-left">Customer</th>
              <th className="px-3 py-2 text-[10px] font-bold text-[#4b5563] uppercase tracking-[0.06em] text-left">Customer PAN</th>
            ...
            {paginatedInvoices.length === 0 ? (
              ...
              paginatedInvoices.map((invoice) => (
                <tr key={invoice.id} className="hover:bg-[#e8eeff]">
                  ...
                  <td className="px-3 py-[7px] text-[12px] text-right font-mono amt amt-dr">Rs. {formatNumber(invoice.vatAmount)}</td>
          ...
          <tfoot className="bg-[#eef1f8] border-t-2 border-[#c5cad8] font-bold">
            <tr>
              ...
              <td className="px-3 py-2 text-[12px] text-right font-mono amt amt-dr">Rs. {formatNumber(totals.vat)}</td>
