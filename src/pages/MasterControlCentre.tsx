...
const MasterControlCentre: React.FC = () => {
  ...
  const accountingCards = [
    ...
    },
    {
      ...
      page: "account-groups",
      count: (accounts || []).filter((a) => a.isGroup).length,
      icon: Layers,
    },
    { label: "Ledger Master", page: "ledgers", count: totalLedgers, icon: BookOpen },
    {
      label: "Voucher Types",
      page: "voucher-types",
      count: (voucherTypeMasters || []).length,
      icon: ScrollText,
    },
    {
      label: "Cost Categories",
      page: "cost-categories",
      count: (costCategories || []).length,
      icon: Map,
    },
    {
      label: "Cost Centre Classes",
      page: "cost-centre-classes",
  ...
  const statutoryCards = [
    {
      ...
      page: "vat-classifications",
      count: (vatClassifications || []).length,
      icon: FileBarChart,
    },
    {
      label: "TDS Nature of Payment",
      page: "tds-nature-of-payments",
      count: (tdsNatureOfPayment || []).length,
      icon: FileText,
    },
    {
      label: "Sale Types (VAT)",
      page: "sale-types",
      count: (saleTypes || []).length,
      icon: TrendingUp,
    },
    {
      label: "Purchase Types",
      page: "purchase-types",
      count: (purchaseTypes || []).length,
      icon: TrendingDown,
    },
    {
    ...
    },
    {
      label: "Bill Sundries",
      page: "bill-sundries",
      count: (billSundryMasters || []).length,
      icon: FileText,
    },
  ];
  ...
  const payrollCards = [
    ...
    },
    {
      label: "Payroll Units",
      page: "payroll-units",
      count: (payrollUnits || []).length,
      icon: Tags,
    },
    {
      label: "Attendance Types",
      page: "attendance-types",
