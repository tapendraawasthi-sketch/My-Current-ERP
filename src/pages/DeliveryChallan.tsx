 ...
 *
 * Delivery note page with list view and new/edit form.
 */
...
const DeliveryChallan: React.FC = () => {
  ...
  }, [deliveryChallans, matchBranch, branchFilter]);
  ...
  return (
    <div className="flex flex-col gap-5 animate-fadeIn text-xs">
      <ActionToolbar title="Delivery note" subtitle="Goods delivery notes" />
      <div className="flex items-center justify-between border-b border-[var(--ds-action-primary)] pb-4">
        <div>
          <h2 className="text-lg font-bold text-[var(--ds-action-primary)] tracking-tight flex items-center gap-2">
            <Truck className="h-5 w-5 text-[var(--ds-action-primary)]" /> Delivery notes
          </h2>
