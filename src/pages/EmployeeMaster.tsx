    ...
    <div className="space-y-4">
      ...
      {!showForm ? (
        <Card className="bg-white border border-[#9DC07A]">
          <div className="p-4 border-b border-[#9DC07A] flex items-center justify-between">
            <input
              type="text"
              placeholder="Search employees..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="h-8 w-64 px-2.5 text-[12px] border border-[#9DC07A] rounded-md focus:outline-none focus:border-[#1557b0]"
            />
          </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {filteredEmployees.map((emp) => (
                  <tr key={emp.id} className="border-b border-[#9DC07A] hover:bg-[#EBF5E2]">
                    <td className="px-3 py-2.5 text-[12px] text-[#000000]">
                      <div className="font-medium">{emp.name}</div>
                      {emp.nameNe && <div className="text-[10px] text-[#000000]">{emp.nameNe}</div>}
                    </td>
                    ...
                    <td className="px-3 py-2.5">
                      {emp.ssf ? (
                        <span className="px-2 py-0.5 rounded text-[10px] font-semibold bg-[#D4EABD] text-[#000000]">
                          SSF ENROLLED
                        </span>
                      ) : (
                ...
                {filteredEmployees.length === 0 && (
                  <tr>
                    <td colSpan={7} className="px-3 py-8 text-center text-[12px] text-[#000000]">
        ...
        <Card className="bg-white border border-[#9DC07A]">
          <div className="p-4 border-b border-[#9DC07A] bg-[#f5f6fa] flex items-center justify-between">
          ...
          <div className="p-4 space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="col-span-2">
                ...
                <input
                  ...
                  className="h-8 px-2.5 w-full text-[12px] border border-[#9DC07A] rounded-md focus:border-[#1557b0] focus:ring-1 focus:ring-[#1557b0]"
                  required
                />
              </div>
              <div className="col-span-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-[#EBF5E2] p-4 border border-[#9DC07A] rounded-md">
