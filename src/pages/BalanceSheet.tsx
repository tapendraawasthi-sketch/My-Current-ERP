  ...
  const renderSection = (title: string, amount: number, breakdown: Array<{groupName: string, ledgerName?: string, amount: number}>) => {
    ...
    return (
      <div className="border-b border-gray-100 last:border-0">
        <div 
          className={`flex items-center justify-between px-3 py-2.5 ${hasChildren ? "cursor-pointer hover:bg-gray-50" : ""}`}
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-[12px] text-gray-700 font-medium">{title}</span>
          </div>
          ...
          <div className="bg-gray-50 border-y border-gray-100 pb-2 pt-1">
            {sectionBreakdown.map((item, idx) => (
              <div key={idx} className="flex justify-between pl-10 pr-3 py-1.5 hover:bg-gray-100">
                <span className="text-[11px] text-gray-600">{item.ledgerName || item.groupName}</span>
    ...
    <div className="space-y-4">
      ...
      <FormPanel>
        ...
        <div className="print-only hidden mb-6 text-center">
          ...
          <p className="text-[11px] text-gray-500">As at: {asOfDate} ({currentFiscalYear?.name})</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 border border-gray-200 rounded-lg bg-white overflow-hidden shadow-sm">
          ...
          <div className="border-r border-gray-200">
            <div className="bg-[#f5f6fa] border-b border-gray-200 px-3 py-2.5">
              <h3 className="text-[10px] font-semibold text-gray-500 uppercase tracking-wide">Assets</h3>
            </div>
          ...
          <div className="flex flex-col">
            <div className="bg-[#f5f6fa] border-b border-gray-200 px-3 py-2.5">
              <h3 className="text-[10px] font-semibold text-gray-500 uppercase tracking-wide">Equity & Liabilities</h3>
            </div>
