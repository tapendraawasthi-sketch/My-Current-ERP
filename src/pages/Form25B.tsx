...
const TAX_SLABS = [
  ...
  { min: 500001, max: 700000, rate: 0.1 },
  { min: 700001, max: 1000000, rate: 0.2 },
  { min: 1000001, max: 2000000, rate: 0.3 },
...
export default function Form25B() {
  ...
  const handlePrintPDF = () => {
    ...
    doc.setFontSize(14);
    doc.text(
      `Total Tax Deducted at Source: ${money(cert.totals.taxDeducted)}`,
      20,
      summaryStartY + 52,
    );
    doc.setFontSize(10);
    ...
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", border: BORDER }}>
          <tbody>
            <tr>
              ...
              <td style={{ border: BORDER, padding: "6px", width: "50%" }}>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", border: BORDER }}>
          <tbody>
            ...
            <tr>
              ...
              <td style={{ border: BORDER, padding: "6px" }}>
                {cert.employee.designation || "N/A"}
              </td>
            </tr>
            <tr>
              <td style={{ border: BORDER, padding: "6px" }}>Department</td>
              <td style={{ border: BORDER, padding: "6px" }}>
                {cert.employee.department || "N/A"}
              </td>
            </tr>
            <tr>
          ...
          <tbody>
            {cert.monthlyData.map((m, idx) => (
              <tr key={idx} style={{ backgroundColor: idx % 2 === 0 ? BG_DEEP : "transparent" }}>
                ...
                <td style={{ border: BORDER, padding: "6px", textAlign: "right" }}>
                  {money(m.grossSalary)}
                </td>
                <td style={{ border: BORDER, padding: "6px", textAlign: "right" }}>
                  {money(m.ssf)}
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", border: BORDER }}>
          <tbody>
            <tr>
              ...
              <td style={{ border: BORDER, padding: "6px", width: "40%", textAlign: "right" }}>
                {money(cert.totals.grossSalary)}
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style={{ border: BORDER, padding: "6px", fontWeight: "bold", fontSize: "14px" }}>
      ...
      >
        ...
        <div style={{ fontSize: "10px" }}>
          I hereby certify that the above amount has been deducted from the salary of the
          above-named employee and deposited to the Inland Revenue Department as per the provisions
    ...
    <div style={{ display: "flex", height: "100vh", backgroundColor: BG }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", backgroundColor: "#FFFFFF" }}>
        {certificates.length > 0 ? (
          certificates.map((cert, idx) => <div key={idx}>{renderCertificate(cert)}</div>)
        ) : (
          <div
            style={{
              display: "flex",
