...
const CashBook: React.FC = () => {
  ...
  const cashAccounts = useMemo(() => {
    return (accounts || []).filter(acc => 
      ...
      (acc.name.toLowerCase().includes("cash") || 
       (acc.parentId && accounts.some(parent => parent.id === acc.parentId && parent.name.toLowerCase().includes("cash"))) ||
  ...
  const data = useMemo(() => {
    ...
    relevantVouchers.forEach(voucher => {
      ...
      switch(voucher.type) {
        ...
        case "contra": voucherTypeLabel = "C"; break;
  ...
  return (
    <ReportShell
      title="Cash Book"
      subtitle="Cash transactions register"
