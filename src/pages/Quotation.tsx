      ...
      <div className="p-6 bg-[#f5f6fa] min-h-screen">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-[11px] text-gray-500 mt-0.5">
              Prepare quotation / pro-forma invoice
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 mb-4">
          ...
          {formErrors.partyName && (
            <p className="text-[11px] text-red-600 mt-2">{formErrors.partyName}</p>
          )}
        </div>
                ...
                <tr key={l.id} className="border-b border-gray-100">
                  ...
                  <td className="px-3 py-2.5">
                    <button
                      ...
                      className="h-7 w-7 border border-red-200 text-red-600 rounded hover:bg-red-50"
                    >
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            {[
              ...
              <div
                key={String(label)}
                className="flex justify-between py-1 text-[12px] text-gray-700"
              >
                <span>{label}</span>
      ...
      <div className="p-6 bg-[#f5f6fa] min-h-screen">
        <div className="no-print flex justify-between mb-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="h-8 px-3 bg-green-600 text-white text-[12px] font-medium rounded-md"
            >
              Mark as Accepted
            </button>
            <button
              onClick={() => setStatus(q, "rejected")}
              className="h-8 px-3 bg-red-600 text-white text-[12px] font-medium rounded-md"
            >
              Mark as Rejected
            </button>
          </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8 max-w-4xl mx-auto text-gray-800">
          <div className="flex justify-between border-b pb-4 mb-4">
            <div>
              <h1 className="text-[18px] font-semibold">
                {currentCompany?.name || currentCompany?.companyNameEn || "Sutra ERP"}
              </h1>
          ...
          <div className="grid grid-cols-2 gap-4 text-[12px] mb-5">
            ...
            <div className="text-right">
              <p>
                Quotation No: <b>{q.quotationNo}</b>
              </p>
            ...
            <thead>
              <tr className="bg-[#f5f6fa]">
                {["#", "Item", "Description", "Qty", "Rate", "Amount", "VAT", "Total"].map((h) => (
                  <th
                    key={h}
                    className="border px-2 py-2 text-left text-[10px] font-semibold text-gray-500 uppercase"
                  >
                    {h}
                  </th>
                ))}
            ...
            <tbody>
              {q.lines.map((l, i) => (
                <tr key={l.id}>
                  ...
                  <td className="border px-2 py-2 text-[12px] text-right">
                    {l.qty} {l.unit}
                  </td>
          ...
          <div className="mt-16 flex justify-end">
            <div className="border-t border-gray-400 pt-2 text-[12px] w-48 text-center">
  ...
  return (
    <div className="p-6 bg-[#f5f6fa] min-h-screen">
      ...
      <p className="text-[11px] text-gray-500 mb-3">
        {quotations.length} quotations | {pending} pending | {converted} converted
      </p>
            ...
            <tbody>
              {filtered.map((q) => (
                <tr key={q.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="px-3 py-2.5">
                    <span
                      className={`px-2 py-0.5 rounded text-[10px] font-semibold uppercase ${statusClass(q.status)}`}
                    >
                      {q.status}
                    </span>
                  </td>
                    ...
                    <div className="flex gap-1">
                      ...
                      {q.status === "draft" && (
                        <button
                          ...
                          className="h-7 w-7 border rounded text-red-600"
                        >
                          <Trash2 className="h-3.5 w-3.5 mx-auto" />
                        </button>
                      )}
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[9999]">
          <div className="bg-white rounded-lg border p-4 w-full max-w-sm">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                onClick={() => deleteRow(showDeleteConfirm)}
                className="h-8 px-3 bg-red-600 text-white text-[12px] rounded-md"
              >
                Delete
              </button>
            </div>
