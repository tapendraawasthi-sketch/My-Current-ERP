...
export const ERP_MODULE_KNOWLEDGE: Record<string, ModuleDoc> = {
  dashboard: {
    description:
      "Main landing page providing a high-level overview of the company's financial and operational status.",
    howToUse: [
    ...
    commonQuestions: [
      {
        ...
        a: "It shows an overview of your sales, purchases, cash flow, and recent activities.",
      },
    ],
  },
  "financial-dashboard": {
    ...
    commonQuestions: [
      {
        q: "How can I view last month's cash flow?",
        a: "Go to the Financial Dashboard and adjust the date filter to last month.",
      },
    ],
  },
  "chart-of-accounts": {
    ...
    commonQuestions: [
      {
        q: "How do I create a new expense account?",
        a: "Go to Chart of Accounts, press F3, enter the name, and select 'Indirect Expenses' as the group.",
      },
    ],
  },
  parties: {
    ...
    commonQuestions: [
      {
        q: "How do I set a credit limit for a customer?",
        a: "Edit the party in Masters -> Parties and set the 'Credit Limit' field.",
      },
    ],
  },
  items: {
    description: "Inventory stock items master.",
    howToUse: ["Go to Masters -> Items.", "Add item name, unit, tax category, and opening stock."],
    ...
    commonQuestions: [
      {
        q: "How to add opening stock?",
        a: "While creating or editing an item, enter the quantity in the 'Opening Stock' field.",
      },
    ],
  },
  "sales-invoice": {
    ...
    commonQuestions: [
      {
        ...
        a: "Go to Transactions -> Sales Invoice, select customer, add items, and press F2 to save.",
      },
      {
        q: "Why is VAT not calculating?",
        a: "Check if the selected item has a VAT-applicable tax category and the party's VAT number is correct.",
      },
    ],
  },
  "purchase-invoice": {
    ...
    commonQuestions: [
      {
        q: "How to enter a purchase bill?",
        a: "Go to Transactions -> Purchase, select supplier, add items, and save.",
      },
    ],
  },
  "sales-return": {
    ...
    commonQuestions: [
      {
        q: "How to process a customer return?",
        a: "Use Transactions -> Sales Return and link it to the original invoice.",
      },
    ],
  },
  "purchase-return": {
  ...
  "payment-voucher": {
    ...
    commonQuestions: [
      {
        q: "How to pay a supplier?",
        a: "Go to Transactions -> Payment, debit the supplier, credit bank/cash.",
      },
    ],
  },
  "receipt-voucher": {
    ...
    commonQuestions: [
      {
        q: "How to record customer payment?",
        a: "Go to Transactions -> Receipt, credit customer, debit bank.",
      },
    ],
  },
  "journal-entry": {
    ...
    commonQuestions: [
      {
        q: "How to enter depreciation?",
        a: "Use a Journal Entry: Debit Depreciation Expense, Credit Accumulated Depreciation/Asset.",
      },
    ],
  },
  "contra-voucher": {
    description: "For cash deposits, withdrawals, or bank-to-bank transfers.",
    howToUse: ["Go to Transactions -> Contra.", "Select Bank and Cash accounts."],
    keyFeatures: ["Cash-Bank only validation"],
    relatedModules: ["journal-entry"],
    commonQuestions: [
      {
        q: "How to record cash deposit to bank?",
        a: "Use Contra Voucher. Debit Bank, Credit Cash.",
      },
    ],
  },
  "balance-sheet": {
    ...
    commonQuestions: [
      {
        q: "Why is Balance Sheet not matching?",
        a: "Check Trial Balance for unbalanced entries or unposted opening balances.",
      },
    ],
  },
  "profit-loss": {
    description: "Shows revenue and expenses for a period.",
    howToUse: ["Go to Reports -> Profit & Loss.", "Select date range."],
  ...
  "trial-balance": {
    ...
    howToUse: ["Go to Reports -> Trial Balance."],
    keyFeatures: ["Group-wise/Ledger-wise view"],
    relatedModules: ["general-ledger"],
    commonQuestions: [
      {
        q: "What does Trial Balance show?",
        a: "It ensures the total of all debit balances equals the total of all credit balances.",
      },
    ],
  },
  "day-book": {
    description: "Chronological list of all transactions for a day.",
    howToUse: ["Go to Reports -> Day Book.", "Select the date."],
  ...
  "vat-reports": {
    ...
    howToUse: ["Go to Reports -> VAT Reports.", "Generate Purchase/Sales Register or VAT Return."],
    keyFeatures: ["CBMS compliant format", "Materialize taxable/non-taxable"],
    relatedModules: ["sales-invoice", "purchase-invoice"],
    commonQuestions: [
      {
        q: "How to prepare VAT return?",
        a: "Go to VAT Reports and generate the VAT Return for the Nepali month.",
      },
    ],
  },
  "system-settings": {
    description: "Global company settings and preferences.",
    howToUse: ["Go to Administration -> System Settings."],
...
export const ACCOUNTING_CONCEPTS: Record<string, string> = {
  "double-entry":
    "Every financial transaction has equal and opposite effects in at least two different accounts (Debit and Credit).",
  debit:
  ...
  "trial-balance":
    "A list of all general ledger accounts and their balances to ensure total debits equal total credits.",
  "balance-sheet":
    "A statement showing a company's assets, liabilities, and equity at a specific point in time.",
  "profit-loss":
    "A statement showing revenues, costs, and expenses over a specific period, resulting in net profit or loss.",
  ...
  "fiscal-year":
    "A 12-month accounting period. In Nepal, it typically starts in Shrawan (mid-July).",
  ...
  outstanding:
    "Amounts owed by customers (receivables) or owed to suppliers (payables) that are not yet paid.",
...
export const ERROR_SOLUTIONS = [
  {
    ...
    solution:
      "Check the difference amount. Verify opening balances in Chart of Accounts. Ensure all journal entries balance.",
  },
  {
    error: "Cannot delete item",
    cause: "Item has existing transaction history.",
    solution:
      "You cannot delete items that have been used in invoices or vouchers. Deactivate it instead.",
  },
  {
    error: "VAT amount incorrect on print",
    cause: "Tax category misconfigured or rounding differences.",
    solution:
      "Verify the Item's tax category is set to 'Taxable 13%'. Check System Settings for rounding preferences.",
  },
];
