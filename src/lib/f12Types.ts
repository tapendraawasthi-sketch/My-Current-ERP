  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          description:
            "Enables multi-line compound entries in vouchers rather than simple debit/credit pairs.",
          type: "boolean",
          defaultValue: false,
        },
        {
          ...
          description:
            "When enabled, the system allows ledger accounts and transactions to be recorded in foreign currencies.",
          type: "boolean",
          defaultValue: false,
        },
        {
          ...
          description:
            "Activates the cost centre dimension across all voucher entry screens. When false, all cost centre fields are hidden system-wide.",
          type: "boolean",
          defaultValue: false,
        },
        {
        ...
        },
        {
          ...
          description:
            "Enables automatic interest computation on outstanding balances for creditors/debtors.",
          type: "boolean",
          defaultValue: false,
        },
      ],
      ...
      fields: [
        {
          ...
          label: "Country",
          description:
            "Selects the operating country. Changes which tax modules, statutory reports, and compliance formats are enabled.",
          type: "dropdown",
          defaultValue: "Nepal",
          options: [
      ...
      fields: [
        {
          ...
          description:
            "When enabled, figures are divided by 1,000,000 and a scale indicator is shown.",
          type: "boolean",
          defaultValue: false,
        },
        {
      ...
      fields: [
        {
          ...
          description:
            "When enabled, a sub-section appears for bank name, branch, account number, IFSC/SWIFT code, and account type.",
          type: "boolean",
          defaultValue: true,
        },
        {
          ...
          description:
            "When enabled, a multi-line address block appears on the ledger form for full mailing/billing address.",
          type: "boolean",
          defaultValue: true,
        },
        {
          ...
          description:
            "When enabled, fields appear for phone, mobile, fax, email address, and website URL.",
          type: "boolean",
          defaultValue: true,
        },
        {
          ...
          description:
            "When true, bill-by-bill settlement tracking is activated even for non-Sundry Debtors/Creditors accounts.",
          type: "boolean",
          defaultValue: false,
        },
        {
          ...
          description:
            "When enabled, shows an opening balance field even for P&L / income-and-expense type accounts.",
          type: "boolean",
          defaultValue: false,
        },
        {
          ...
          description:
            "When enabled, fields appear to define interest rate, calculation basis, style (simple/compound), and grace period.",
          type: "boolean",
          defaultValue: false,
        },
        {
          ...
          description:
            "When enabled, fields appear for PAN, VAT number, and other tax identification numbers.",
          type: "boolean",
          defaultValue: true,
        },
      ],
      ...
      fields: [
        {
          ...
          description:
            "When false, the date defaults to the last-used date and the cursor skips it.",
          type: "boolean",
          defaultValue: true,
        },
        {
          ...
          description:
            "When false, the narration/description line at the bottom of the voucher is suppressed.",
          type: "boolean",
          defaultValue: true,
        },
        {
          ...
          description:
            "When true, after each ledger line the system asks to allocate the amount to one or more cost centres.",
          type: "boolean",
          defaultValue: false,
        },
        {
          ...
          description:
            "When true, a sub-screen appears to specify which invoice a payment/receipt is against.",
          type: "boolean",
          defaultValue: true,
        },
      ],
      ...
      fields: [
        {
          ...
          description:
            "When true, shows a simplified two-sided form. When false, multi-entry mode allows complex compound vouchers.",
          type: "boolean",
          defaultValue: false,
        },
        {
          ...
          description:
            "When true, the narration field auto-populates with the narration from the most recently saved voucher of the same type.",
          type: "boolean",
          defaultValue: false,
        },
      ],
      ...
      fields: [
        {
          ...
          description:
            "When true, alerts the user if a sales voucher would cause a stock item quantity to go negative.",
          type: "boolean",
          defaultValue: true,
        },
        {
          ...
          description:
            "When true, warns of a potential duplicate entry if the invoice number has already been recorded.",
          type: "boolean",
          defaultValue: true,
        },
      ],
      ...
      fields: [
        {
          ...
          description:
            "When true, the current balance of a selected ledger account is shown inline.",
          type: "boolean",
          defaultValue: true,
        },
        {
          ...
          description:
            "When true, after the voucher is saved, the updated balance of the primary ledger is shown.",
          type: "boolean",
          defaultValue: false,
        },
      ],
      ...
      fields: [
        {
          ...
          description:
            "When true, the user can override the auto-calculated tax rate or tax amount on individual voucher lines.",
          type: "boolean",
          defaultValue: false,
        },
        {
          ...
          description:
            "A master override that enables the user to edit every field of a voucher that would otherwise be locked.",
          type: "boolean",
          defaultValue: false,
        },
      ],
  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          description:
            "When true, a sub-screen appears to specify which bill this payment is against.",
          type: "boolean",
          defaultValue: true,
        },
      ],
      ...
      fields: [
        {
          ...
          description:
            "When true, the user can add ledger lines from expense account groups (freight, packing charges) alongside the purchase ledger line.",
          type: "boolean",
          defaultValue: false,
        },
        {
          ...
          description:
            "Permits ledger lines from fixed asset account groups in a purchase voucher. Needed when purchasing capital equipment.",
          type: "boolean",
          defaultValue: false,
        },
        {
      ...
      fields: [
        {
          ...
          label: "Warn If Same Bill Reference Exists",
          description:
            "When true, warns of a potential duplicate if the supplier invoice number has already been recorded.",
          type: "boolean",
          defaultValue: true,
        },
      ],
      ...
      fields: [
        {
          ...
          label: "Modify Tax Rate Details",
          description:
            "When true, the user can override the auto-calculated tax rate on individual voucher lines.",
          type: "boolean",
          defaultValue: false,
        },
      ],
  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: "Show Cost Centre Allocation",
          description:
            "When true, after each ledger line the system prompts for cost centre allocation.",
          type: "boolean",
          defaultValue: false,
        },
        {
          ...
          label: "Show Bill-Wise Details",
          description:
            "When true, a sub-screen appears to specify which outstanding bill this payment is against.",
          type: "boolean",
          defaultValue: true,
        },
      ],
      ...
      fields: [
        {
          ...
          description:
            "When true, if a payment voucher would cause cash-in-hand to go negative, the system warns before saving.",
          type: "boolean",
          defaultValue: true,
        },
      ],
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: "Show Closing Balance After Saving",
          description:
            "After the voucher is saved, shows the updated balance of the primary ledger.",
          type: "boolean",
          defaultValue: true,
        },
      ],
  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: "Show Bill-Wise Details",
          description:
            "When true, a sub-screen appears to specify which outstanding invoice this receipt is against.",
          type: "boolean",
          defaultValue: true,
        },
      ],
  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: "Show Bill-Wise Details",
          description:
            "When true, a sub-screen for bill references appears after each debtor/creditor line.",
          type: "boolean",
          defaultValue: false,
        },
      ],
      ...
      fields: [
        {
          ...
          label: "Show Ledger Balance as You Enter",
          description:
            "When true, the current balance of each bank/cash account is shown as the user selects it.",
          type: "boolean",
          defaultValue: true,
        },
      ],
  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          description:
            "When true, Dr and Cr amounts are shown in separate columns. When false, a single net-balance column is used.",
          type: "boolean",
          defaultValue: true,
        },
        {
        ...
        },
        {
          ...
          description:
            "Includes accounts with no movement in the period (which are normally suppressed).",
          type: "boolean",
          defaultValue: false,
        },
      ],
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          description:
            "Rounds all displayed values to whole numbers (does not affect stored data).",
          type: "boolean",
          defaultValue: false,
        },
        {
      ...
      fields: [
        {
          ...
          description:
            "Adds a sub-total for net current assets (current assets minus current liabilities).",
          type: "boolean",
          defaultValue: false,
        },
        {
      ...
      fields: [
        {
          ...
          description:
            "Expands each stock item to show quantity and value per storage location (godown/warehouse).",
          type: "boolean",
          defaultValue: false,
        },
        {
        ...
        },
        {
          ...
          description:
            "Shows separate columns for quantities received and dispatched in the period.",
          type: "boolean",
          defaultValue: false,
        },
      ],
