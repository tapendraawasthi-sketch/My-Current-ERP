...
export default function PLDetailedMonthly({ pl, options, onDrillDown }: Props) {
  const accounts = useMemo(() => {
    if (!pl.monthlyData || !pl.monthLabels) return [];
  ...
  const td0Cls =
    "px-3 py-1.5 text-right font-mono text-[11px] text-gray-300 border-l border-gray-100";
                ...
                <tr
                  ...
                  onClick={() =>
                    onDrillDown({
                      ...
                      selectedGroupId: acc.group,
                      selectedGroupLabel: acc.group,
