...
const ModeRestrictionCard: React.FC<ModeRestrictionCardProps> = ({
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 border-b border-[var(--ds-intelligence-border)] bg-[var(--ds-intelligence-surface)] px-3.5 py-3">
        <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-[var(--ds-surface)] text-[var(--ds-intelligence)]">
