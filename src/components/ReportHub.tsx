      ...
      {reportCategories.map((cat) => (
        ...
        >
          <div
            ...
            style={{ borderColor: "var(--border)", background: "#f8faff" }}
          >
            <div
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-0">
            {cat.reports.map((r) => (
              <button
                ...
                className="flex flex-col items-start gap-0.5 p-3 text-left hover:bg-blue-50 transition-colors border-r border-b cursor-pointer"
                style={{ borderColor: "var(--border)" }}
              >
