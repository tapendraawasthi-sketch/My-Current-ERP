...
const Sidebar: React.FC<SidebarProps> = ({ collapsed, setCollapsed }) => {
  ...
  const [expandedGroups, setExpandedGroups] = useState<Record<string, boolean>>({ Overview: true, Masters: false, Transactions: true, Inventory: false, "Accounts Books": false, Reports: false, Administration: false });
