...
const TallyVault = () => {
  ...
  const handleDisableEncryption = () => {
    ...
    if (
      !window.confirm(
        "Are you SURE you want to disable TallyVault encryption? Company data will be unencrypted on disk.",
      )
    ) {
      return;
    }
    ...
    <div className="max-w-[700px] mx-auto p-5 font-sans">
      ...
      <div className="bg-[#1e2433] px-4 py-3 rounded-t-lg flex justify-between items-center border-b border-gray-700 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[14px] font-semibold text-white tracking-wide">
            TallyVault — Company Data Encryption
          </span>
        </div>
        <div
      ...
      <div className="bg-gray-50 px-4 py-2 border-x border-gray-200 flex items-center gap-2 shadow-sm">
        ...
        <span className="text-[12px] font-medium text-gray-800">
          {companySettings?.name || "Current Company"}
        </span>
      </div>
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <div className="bg-white border border-gray-200 rounded-md p-4 shadow-sm">
              ...
              <ul className="text-[11px] text-gray-700 space-y-2 list-disc pl-4">
                <li>
                  <span className="font-medium text-gray-800">AES-256 encryption</span> — industry
                  standard, used by banks.
                </li>
                ...
                <li className="text-red-600 font-medium">
                  If you forget the password, data CANNOT be recovered. No backdoor exists.
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-100">
                  ...
                  <tr>
                    ...
                    <td className="px-3 py-2 text-[11px] text-red-600 font-medium">
              ...
              <div className="m-3 p-2 bg-amber-50 border border-amber-200 rounded-md flex gap-2">
                ...
                <div className="text-[10px] text-amber-800 leading-snug">
                  <span className="font-semibold uppercase tracking-wide">Important:</span> Store
                  your TallyVault password in a secure location (e.g., password manager, sealed
                  envelope). Nobody can recover encrypted data without the password.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-md p-5 shadow-sm max-w-md mx-auto">
            ...
            <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded-md flex gap-2 items-start">
              ...
              <div className="text-[11px] text-amber-800 leading-snug">
                Enabling TallyVault will encrypt all data files on disk. You will need to enter this
                password every time you open this company.{" "}
                <span className="font-semibold text-red-600">
                  If forgotten — data is PERMANENTLY INACCESSIBLE with no recovery option.
                </span>
              </div>
            </div>
              ...
              <div className="mb-3 bg-gray-50 p-2.5 rounded border border-gray-100">
                <div className="flex gap-1 h-1.5 mb-1.5">
                  {[0, 1, 2, 3].map((i) => (
                    <div
                      ...
                      style={{
                        backgroundColor: i < strength ? strengthColors[strength] : undefined,
                      }}
                    />
                  ))}
                </div>
                ...
                <div className="text-[10px] mt-2 space-y-1 text-gray-600">
                  <div className="flex items-center gap-1.5">
                    <span className={password.length >= 8 ? "text-[#059669]" : "text-gray-400"}>
                      {password.length >= 8 ? "✓" : "○"}
                    </span>
                    <span>Minimum 8 characters</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className={/[A-Z]/.test(password) ? "text-[#059669]" : "text-gray-400"}>
                      {/[A-Z]/.test(password) ? "✓" : "○"}
                    </span>
                    <span>At least one uppercase letter</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className={/[0-9]/.test(password) ? "text-[#059669]" : "text-gray-400"}>
                      {/[0-9]/.test(password) ? "✓" : "○"}
                    </span>
                  ...
                  <div className="flex items-center gap-1.5">
                    <span
                      className={/[!@#$%^&*]/.test(password) ? "text-[#059669]" : "text-gray-400"}
                    >
                      {/[!@#$%^&*]/.test(password) ? "✓" : "○"}
                    </span>
            ...
            <div className="mb-4">
              ...
              {confirmPassword.length > 0 && confirmPassword !== password && (
                <div className="text-[#dc2626] text-[10px] mt-1 font-medium">
          ...
          <div className="bg-white border border-gray-200 rounded-md p-5 shadow-sm max-w-md mx-auto">
            ...
            <div className="mb-5 p-3 bg-red-50 border border-red-200 rounded-md flex gap-2 items-start">
              ...
              <div className="text-[11px] text-red-800 leading-snug">
                <span className="font-semibold uppercase tracking-wide">Danger:</span> Disabling
                TallyVault will DECRYPT all data files. Anyone with access to the data folder will
                be able to read company data. This action cannot be undone without re-enabling.
              </div>
            </div>
