    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ flex: 1 }}>
          ...
          {children && isActive && <div style={{ marginTop: "8px" }}>{children}</div>}
        </div>
        ...
        >
          {features.enable_payroll_statutory && (
            <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginTop: "8px" }}>
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                <div style={{ flex: 1 }}>
                  <label style={{ fontSize: 12, color: "#000" }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleTextChange("ssf_employee_rate", parseFloat(e.target.value) || 0)
                    }
                    style={{
                      width: "100%",
                      padding: "6px",
                ...
                <div style={{ flex: 1 }}>
                  <label style={{ fontSize: 12, color: "#000" }}>
                    SSF Employer Contribution Rate %
                  </label>
                  <input
                    type="number"
                    value={features.ssf_employer_rate}
                    onChange={(e) =>
                      handleTextChange("ssf_employer_rate", parseFloat(e.target.value) || 0)
                    }
                    style={{
                      width: "100%",
                      padding: "6px",
              ...
              >
                Per Nepal Social Security Act 2074: Employee contributes 11%, Employer contributes
                20% of basic + grade pay to SSF (Social Security Fund). Register at ssf.gov.np
              </div>
