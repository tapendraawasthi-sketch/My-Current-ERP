            ...
            {(["BS", "AD"] as const).map((tab) => (
              <button
                ...
                className={`flex-1 py-1 text-[11px] font-semibold rounded transition-colors cursor-pointer ${
                  activeTab === tab
                    ? "bg-[#3b6fd4] text-white shadow-sm"
            ...
            <div>
              ...
              <div className="flex items-center justify-between mb-2">
                <button
                  ...
                  className="p-1.5 hover:bg-[#3b6fd4]/30 rounded transition-colors"
                >
              ...
              <div className="grid grid-cols-7 gap-0.5 text-center mb-1">
                {NEPALI_DAYS.map((d) => (
                  <div key={d} className="text-[9px] text-white/60 font-semibold py-0.5">
                    {d}
                  </div>
                ))}
              </div>
