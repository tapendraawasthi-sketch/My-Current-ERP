...
export const DisplayLanguageModal: React.FC<{
  ...
  const [selected, setSelected] = useState(localStorage.getItem("displayLanguage") || "en-IN");
      ...
      >
        ...
        <div className="bg-[#1e2433] px-4 py-3 flex justify-between items-center border-b border-gray-700">
          <div>
            ...
            <div className="text-[10px] text-gray-400 mt-0.5">Ctrl+K</div>
          </div>
          <button
            onClick={onClose}
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[11px] text-gray-500 truncate mt-0.5">{lang.region}</div>
                </div>
